...
void Coshelf::getCoBook() {
	...
	//找co文件
	p.assign("C:\\Users\\lenovo\\Desktop\\书\\").append(getName()).append("\\*.co*");
	...
	if ((hFile = _findfirst(p.c_str(), &fileinfo)) != -1) {
		...
		do {
			...
			if (strcmp(fileinfo.name, ".") != 0 && strcmp(fileinfo.name, "..") != 0) {
				...
				string t;
				t.assign("C:\\Users\\lenovo\\Desktop\\书\\").append(getName()).append("\\").append(fileinfo.name);
